...
-- Volcando datos para la tabla fykka.login: ~3 rows (aproximadamente)
DELETE FROM `login`;
...
CREATE TABLE IF NOT EXISTS `proyecto` (
  ...
  `pro_estado` enum('INICIADO','TERMINADO','SUSPENDIDO','ESPERA') NOT NULL DEFAULT 'ESPERA',
  PRIMARY KEY (`pro_ide`),
...
-- Volcando datos para la tabla fykka.proyecto: ~10 rows (aproximadamente)
DELETE FROM `proyecto`;
/*!40000 ALTER TABLE `proyecto` DISABLE KEYS */;
INSERT INTO `proyecto` (`pro_ide`, `pro_nombre`, `pro_fecha_creacion`, `pro_fecha_inicio`, `pro_descripcion`, `pro_encargado`, `pro_fecha`, `pro_porcentaje`, `pro_estado`) VALUES
	(1, 'asdasdasdad', '2018-12-14', '0000-00-00', 'asdadad', 1, '2018-12-14 11:53:55', 0, 'ESPERA'),
	(2, 'Proyecto 1', '2018-12-14', '0000-00-00', 'asdasdadasdads', 1, '2018-12-14 13:18:02', 0, 'ESPERA'),
	(3, 'aceituno', '2018-12-14', '0000-00-00', 'asdadadadadasdasd', 1, '2018-12-14 13:29:36', 0, 'ESPERA'),
	(4, 'sadasdasdasdasd', '2018-12-14', '0000-00-00', 'asdasdasdasdasd', 1, '2018-12-14 13:31:40', 0, 'ESPERA'),
	(5, 'asdasdasd', '2018-12-14', '0000-00-00', 'asdasdsad', 1, '2018-12-14 13:32:42', 0, 'ESPERA'),
	(6, 'sadasdasdas', '2018-12-14', '0000-00-00', 'asdasdasd', 1, '2018-12-14 13:33:17', 0, 'ESPERA'),
	(7, 'asdasdasdasdas', '2018-12-14', '0000-00-00', 'asdasdasdasd', 1, '2018-12-14 13:33:39', 0, 'ESPERA'),
	(8, 'asdasdasd', '2018-12-14', '0000-00-00', 'asdasdasdasd', 1, '2018-12-14 13:34:40', 0, 'ESPERA'),
	(9, 'asdasdasdasdasda', '2018-12-14', '0000-00-00', 'asdasdasdasdasdasdasd', 1, '2018-12-14 13:39:43', 0, 'ESPERA'),
